...
public class ProbabilityOntTester {
    ...
    public static void main(String[] args) {
        ...
        analyzer.addAlignmentDataOntology(makeTestLearningDataset(analyzer.getAlignedSchemaOntModel(), 1000),
                HCTX_ONT_NAMESPACE, "hctx");
        analyzer.addAlignmentDataOntology(makeTestAnalysintInputDataset(analyzer.getAlignedSchemaOntModel(), 50),
                HCTX_ONT_NAMESPACE, "hctx");
